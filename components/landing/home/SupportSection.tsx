        ...
        <div className="space-y-12 md:space-y-0">
          {features.map((feature, index) => (
            ...
            >
              ...
              <div
                className={`hidden md:flex absolute left-1/2 transform -translate-x-1/2 w-11 h-11 rounded-full ${feature.color} items-center justify-center z-10 shadow-sm `}
              >
              ...
              <div
                className={`md:hidden mb-4 w-10 h-10 rounded-full ${feature.color} flex items-center justify-center text-white font-bold`}
              >
                {feature.id}
              </div>
