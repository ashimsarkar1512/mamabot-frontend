...
export default function SupportCards() {
  ...
  const mail1 = data?.data?.mail_1 || "support@mamabot.com";
  const mail2 = data?.data?.mail_2 || "support@mamabot.com";
  const workingHour = data?.data?.working_hour || "Mon-Fri 9am-5pm";
  return (
    <section
      id="support-feedback"
    ...
    >
      ...
      <section
        id="support"
        className="relative bg-[#FBE9F2] border-2 !border-white rounded-3xl p-6 md:p-12 shadow-lg hover:shadow-xl transition-shadow duration-300"
      >
        {/* Icon + Title */}
      ...
      <section
        id="feedback"
        className="relative bg-[#DEF0F8] border-2 !border-white rounded-3xl p-6 md:p-12 shadow-lg hover:shadow-xl transition-shadow duration-300"
      >
        {/* Icon + Title */}
        <div className="flex items-center mb-6">
          <div className="w-9 md:w-14 h-9 md:h-14 rounded-full flex items-center justify-center mr-2 md:mr-4">
        ...
        {/* Button */}
        <button
          onClick={() => (window.location.href = `mailto:${mail2}`)}
