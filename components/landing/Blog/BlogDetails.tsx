                  ...
                  <div>
                    ...
                    <div className="text-base md:text-lg ">
                      <p className="mb-5 md:mb-10">
                        ...
                        your body’s healing process after giving birth. Whether
                        you had a vaginal delivery or a C-section, your uterus
                        is working to return to its pre-pregnancy size, shed
                        excess tissue, and regulate hormonal changes. These
                        symptoms can feel uncomfortable or even worrying,
                        especially for first-time mothers, but understanding
                        what’s normal can help you recover with confidence.
                      </p>

                      <p className="mb-5 md:mb-10">
                        During the first few weeks after birth, you’ll notice
                        bleeding known as lochia, along with mild to moderate
                        cramping caused by uterine contractions. These
                        experiences vary from mom to mom depending on your
                        delivery type, breastfeeding activity, and your body’s
                        individual pace of healing. Most symptoms gradually ease
                        as the weeks progress, but it’s important to recognize
                        when something doesn’t feel right. Recovering from
                        childbirth takes time, rest, hydration, and awareness of
                        your body’s signals. This guide walks you through what’s
                        normal, what requires attention, and helpful ways to
                    ...
                    <div className="mb-4">
                      ...
                      <p className="text-base md:text-lg">
                        ...
                        Understanding what to expect and recognizing when
                        symptoms are unusual can help you stay healthy and
                        confident throughout your healing journey. Whether your
                        delivery was vaginal or via C-section, remember that
                        progress is gradual. Prioritize rest, hydration, and
                        gentle care. If something doesn’t feel right, don't
                        hesitate to reach out to a healthcare provider. Your
                        well-being matters every single day of this postpartum
                        phase
                      </p>
                    </div>
                  </div>
