...
function LandingPage({ store, chat }: any) {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-[#FDFDFD] relative overflow-y-auto">
          ...
          <div className="w-full mt-10">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="border border-blue-100 bg-blue-50/30 p-4 rounded-xl cursor-pointer hover:border-blue-200 transition-colors">
                   <h4 className="font-semibold text-gray-800 text-sm mb-1">You Could Use Some of Your Equity To Put Down on Your Next Home</h4>
                   <p className="text-xs text-gray-500 line-clamp-2">If you&apos;re a homeowner, chances are you&apos;ve built up a lot of wealth...</p>
                   <div className="mt-2 text-[10px] text-gray-400">May 21, 2025</div>
                </div>
                <div className="border border-blue-100 bg-blue-50/30 p-4 rounded-xl cursor-pointer hover:border-blue-200 transition-colors">
                   <h4 className="font-semibold text-gray-800 text-sm mb-1">More Homes for Sale Isn&apos;t a Warning Sign – It&apos;s Your Buying Opportunity</h4>
                   <p className="text-xs text-gray-500 line-clamp-2">If you&apos;re a homeowner, chances are you&apos;ve built up a lot of wealth...</p>
                   <div className="mt-2 text-[10px] text-gray-400">May 21, 2025</div>
                </div>
             </div>
       ...
       {/* Upgrade Pro Tab */}
       <div className="absolute right-0 top-1/2 transform -translate-y-1/2 bg-pink-500 text-white py-4 px-1 rounded-l-md writing-mode-vertical cursor-pointer">
          <span className="block transform -rotate-180" style={{ writingMode: 'vertical-rl' }}>Upgrade Pro</span>
       </div>
    </div>
  );
}
