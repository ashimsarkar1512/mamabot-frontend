...
export default function RecoveryDashboardSections() {
  ...
  return (
    <div className="space-y-8 mb-8">
      {/*   RECOVERY & HEALING   */}
      <div>
        <h2 className="text-base md:text-xl xl:text-2xl text-[#229ECF] pb-3 border-b border-[#229ECF]/40! mb-6">
          Recovery & Healing
        </h2>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {/* Pain Score Card */}
          <div className="flex justify-between items-center gap-4 p-3 md:p-8 rounded-xl border-2 border-white! bg-white/30 shadow-sm hover:shadow-md">
            <div className="flex md:items-center gap-4 e!">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {/* Mental Health */}
          <div className="py-5 md:py-25 rounded-xl border-2 border-white! bg-white/30 shadow-sm hover:shadow-md text-center space-y-4 ">
