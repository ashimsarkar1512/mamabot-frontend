...
import { Heart, MessageCircle, Trash2, Filter, Settings2, Clock, MessageSquareText } from "lucide-react";
        ...
        <div className="space-y-8">
            ...
            <div className="flex items-center gap-3">
                ...
                {[
                    ...
                    <button
                        ...
                        className={`px-6     py-3 rounded-xl border text-md font-medium transition ${activeTab === tab.key
            ...
            <div className="space-y-6">
                {filteredPosts.map((post) => (
                    <div
                        key={post.id}
                        className={`rounded-xl p-6 bg-white hover:shadow-sm transition duration-500 ${post.reported ? "border border-orange-300!" : ""
                            }`}
                    >
                        <div className="flex items-start justify-between">
                            <div>
                                <h3 className="font-semibold text-lg xl:text-xl">{post.author}</h3>
