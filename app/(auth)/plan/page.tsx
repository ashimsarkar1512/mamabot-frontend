    ...
    <div className="min-h-screen px-6 py-10 relative">
      ...
      <div className="max-w-6xl mx-auto my-10">
        ...
        <p className="max-w-2xl text-gray-500">
          Whether you’re expecting, a new mom, or exploring expert advice — Mamabot grows with you.
          Start free, and upgrade anytime for unlimited AI support and exclusive features.
        </p>
      </div>
